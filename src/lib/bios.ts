...
// may name the product and link it — that is what the field is for.
...
And anything that leaves — a published article, a reply to a customer, an email to a stranger — waits for a person to say yes.
